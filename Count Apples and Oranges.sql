...
SELECT 
SUM(t1.apple_count + t1.apple_count2) AS apple_count,
SUM(t1.orange_count + t1.orange_count2) AS orange_count
FROM
(
SELECT b.apple_count, b.orange_count,
CASE WHEN c.apple_count IS NOT NULL THEN c.apple_count ELSE 0 END AS apple_count2,
CASE WHEN c.orange_count IS NOT NULL THEN c.orange_count ELSE 0 END AS orange_count2
