...
SELECT 
*,
RANK() OVER (PARTITION BY account_id ORDER BY login ASC) as rank2
FROM LogInfo 
)
...
INNER JOIN 
rank_log r2
ON r1.account_id = r2.account_id AND r1.rank2 = r2.rank2 -1
WHERE r1.logout >= r2.login AND r1.ip_address != r2.ip_address
